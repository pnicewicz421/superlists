...
from fabric.api import env, local, run, task, run
...
user = "elspeth"
host = "peternicewicz.com"
REPO_URL = 'https://github.com/pnicewicz421/superlists.git'
...
#@task
#@ec2instance(nametag="peternicewicz.com")
